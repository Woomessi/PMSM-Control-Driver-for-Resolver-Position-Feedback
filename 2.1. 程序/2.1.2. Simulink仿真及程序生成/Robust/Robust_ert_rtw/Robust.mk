###########################################################################
## Makefile generated for component 'Robust'. 
## 
## Makefile     : Robust.mk
## Generated on : Wed Feb 26 19:58:34 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Robust.exe
...
START_DIR                 = C:/Users/WUHONG~1/Desktop/交接材~1/20A04~1.工/2195C3~1.程/212~1.SIM/Robust
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Robust_comp.rsp
CMD_FILE                  = Robust.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Robust.exe
...
DEFINES_STANDARD = -DMODEL=Robust -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/Robust_ert_rtw/Robust.c $(START_DIR)/Robust_ert_rtw/Robust_data.c

MAIN_SRC = $(START_DIR)/Robust_ert_rtw/ert_main.c
...
OBJS = Robust.obj Robust_data.obj
...
%.obj : $(START_DIR)/Robust_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Robust_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Robust_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Robust_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Robust_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Robust.obj : $(START_DIR)/Robust_ert_rtw/Robust.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Robust_data.obj : $(START_DIR)/Robust_ert_rtw/Robust_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/Robust_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
