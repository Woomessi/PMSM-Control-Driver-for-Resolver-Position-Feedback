###########################################################################
## Makefile generated for component 'AntiPark'. 
## 
## Makefile     : AntiPark.mk
## Generated on : Tue Mar 25 15:57:50 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/AntiPark.exe
...
COMPILER_COMMAND_FILE     = AntiPark_comp.rsp
CMD_FILE                  = AntiPark.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/AntiPark.exe
...
DEFINES_STANDARD = -DMODEL=AntiPark -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/AntiPark_ert_rtw/AntiPark.c
...
%.obj : $(START_DIR)/AntiPark_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/AntiPark_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/AntiPark_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/AntiPark_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/AntiPark_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
AntiPark.obj : $(START_DIR)/AntiPark_ert_rtw/AntiPark.c
	$(CC) $(CFLAGS) -o "$@" "$<"
