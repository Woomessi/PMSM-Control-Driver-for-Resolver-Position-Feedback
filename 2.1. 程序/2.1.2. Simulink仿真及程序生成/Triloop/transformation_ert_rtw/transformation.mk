###########################################################################
## Makefile generated for component 'transformation'. 
## 
## Makefile     : transformation.mk
## Generated on : Tue Mar 25 16:17:02 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/transformation.exe
...
START_DIR                 = C:/Users/WUHONG~1/Desktop/交接材~1/20A04~1.工/2195C3~1.程/212~1.SIM/Triloop
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = transformation_comp.rsp
CMD_FILE                  = transformation.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/transformation.exe
...
DEFINES_STANDARD = -DMODEL=transformation -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/transformation_ert_rtw/transformation.c
...
%.obj : $(START_DIR)/transformation_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/transformation_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/transformation_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/transformation_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/transformation_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
transformation.obj : $(START_DIR)/transformation_ert_rtw/transformation.c
	$(CC) $(CFLAGS) -o "$@" "$<"
